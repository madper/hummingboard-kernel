...
class KernelMadperPlugin(kbuild.KBuildPlugin):
	...
	subprocess.check_call(
	    'mkimage -n "RamdiskImage" -A arm -O linux -T ramdisk -C gzip -d {} ramfs.img'.format(initrd_path), shell=True, cwd=initrd_unpacked_path)
